...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    public VentanaPrincipal() {
        ...
        historialOperaciones = HistorialOperaciones.getInstancia(); 
    ...
    private void actualizarTablas(){
        ...
        for (ProductoNormal producto : inventarioA.obtenerProductos()){
            modeloInventarioA.addRow(new Object[]{producto.getNombre(),producto.getCantidad()});
        }
        
        for (ProductoNormal producto : inventarioB.obtenerProductos()){
